...
public class Vaccine {
	private String[] vaccineCodeAndDate;
	private String vaccineCvxCode;
	private String vaccineAdministratedDate;
	private String vaccineNDC;
	private String manufacturer;
	private String lotNumber;
	private String eventInformationSource;
	private String administeringProvider;
	private String administeringAtLocation;
	...
	private String visInformationType;
	private String visInformationPublicationDate;
	private String visInformationDateGivenToPatient;
	private String vaccineEligibility;
	...
	public String getAdministeringAtLocation() {
		return administeringAtLocation;
	}
	public void setAdministeringAtLocation(String administeringAtLocation) {
		this.administeringAtLocation = administeringAtLocation;
	}
	...
	public String getVaccineAdministratedDate() {
		return vaccineAdministratedDate;
	}
	public void setVaccineAdministratedDate(String vaccineAdnistratedDate) {
		this.vaccineAdministratedDate = vaccineAdnistratedDate;
	}
	public String[] getVaccineCodeAndDate() {
		return vaccineCodeAndDate;
	}
	public void setVaccineCodeAndDate(String[] vaccineCodeAndDate) {
		this.vaccineCodeAndDate = vaccineCodeAndDate;
	}
	public String getVaccineNDC() {
		return vaccineNDC;
	}
	public void setVaccineNDC(String vaccineNDC) {
	...
	public String getEventInformationSource() {
		return eventInformationSource;
	}
	public void setEventInformationSource(String eventInformationSource) {
		this.eventInformationSource = eventInformationSource;
	}
	...
	public String getVisInformationType() {
		return visInformationType;
	}
	public void setVisInformationType(String visInformationType) {
		this.visInformationType = visInformationType;
	}
	public String getVisInformationPublicationDate() {
		return visInformationPublicationDate;
	}
	public void setVisInformationPublicationDate(String visInformationPublicationDate) {
		this.visInformationPublicationDate = visInformationPublicationDate;
	}
	public String getVisInformationDateGivenToPatient() {
		return visInformationDateGivenToPatient;
	}
	public void setVisInformationDateGivenToPatient(String visInformationDateGivenToPatient) {
		this.visInformationDateGivenToPatient = visInformationDateGivenToPatient;
	}
	public String getVaccineEligibility() {
		return vaccineEligibility;
	}
	public void setVaccineEligibility(String vaccineEligibility) {
		this.vaccineEligibility = vaccineEligibility;
	}
